...
export default class base1664 {

    static base64Chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
    
    static textUTF8toBase64(str: string, urlMode: boolean = true): string {
        let base64: string;
    ...
    static base64toTextUTF8(base64String: string): string | null {
    ...
    static Uint8ArrToTextUTF8(Uint8Arr: Uint8Array): string {
    ...
    static Uint8ArrToBase64(Uint8Arr: Uint8Array, urlMode: boolean = false): string {
    ...
    static hexToBase64(hexStr: string, urlMode: boolean = false): string {
        const Uint8Arr = base1664.hexToUint8Arr(hexStr);
        return base1664.Uint8ArrToBase64(Uint8Arr, urlMode);
    }

    static base64ToHex(base64String: string): string | null {
        if (!base64String.length) {
            return '';
        }
    ...
    static Uint8ArrToHexStr(Uint8Arr: Uint8Array) {
    ...
    static clearBase64ToHex(base64String: string): string {
        let hexString = '';
